// SAT practice question bank.
// Each question: { section: 'rw' | 'math', skill, passage?, prompt, choices[], answer (index), explanation }
export const BANK = [
  /* ---------- READING & WRITING ---------- */
  {
    section: 'rw', skill: 'Words in Context',
  ...
  {
    section: 'rw', skill: 'Command of Evidence',
  ...
  {
    section: 'rw', skill: 'Central Ideas',
  ...
  {
    section: 'rw', skill: 'Boundaries (Punctuation)',
  ...
  {
    section: 'rw', skill: 'Form & Structure (Verbs)',
  ...
  {
    section: 'rw', skill: 'Boundaries (Modifiers)',
  ...
  {
    section: 'rw', skill: 'Subject-Verb Agreement',
  ...
  {
    section: 'rw', skill: 'Rhetorical Synthesis',
  ...
  {
    section: 'rw', skill: 'Pronoun Agreement',
  ...
  /* ---------- MATH ---------- */
  {
    section: 'math', skill: 'Linear Equations',
  ...
  {
    section: 'math', skill: 'Percentages',
  ...
  {
    section: 'math', skill: 'Ratios & Proportions',
  ...
  {
    section: 'math', skill: 'Systems of Equations',
  ...
  {
    section: 'math', skill: 'Slope & Lines',
  ...
  {
    section: 'math', skill: 'Geometry (Area)',
  ...
  {
    section: 'math', skill: 'Geometry (Triangles)',
  ...
  {
    section: 'math', skill: 'Statistics (Mean)',
  ...
  {
    section: 'math', skill: 'Linear Functions',
  ...
  {
    section: 'math', skill: 'Probability',
  ...
  {
    section: 'math', skill: 'Inequalities',
  ...
  {
    section: 'math', skill: 'Exponential Growth',
...
export const SECTION_ORDER = ['rw', 'math'];
